                    ...
                    <div className="row">
                      ...
                      <div className="col-7 d-flex align-items-center">
                        <div className="numbers">
                          ...
                          <h4 className="card-title">M 5,345</h4>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="card-body">
                    <div className="progress-card">
                      <div className="d-flex justify-content-between mb-1">
                        ...
                        <span className="text-muted fw-bold"> M3K</span>
                      </div>
                      ...
                      <table className="table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>Buy 10 Cows For Beef Meat</td>
                          ...
                          <tr>
                            ...
                            <td>Add Sea Food On The Menu</td>
                            <td className="td-actions text-right">
                              <div className="form-button-action">
                                <button
                                  type="button"
                          ...
                          <tr>
                            ...
                            <td>Sell Cocktales In 6 Months Down The Line</td>
                            <td className="td-actions text-right">
                              <div className="form-button-action">
                                <button
                                  type="button"
